"""
Create 4 unique direct programmes for each KCCA division with KPIs and random progress.
...
for div in divisions:
    ...
    for idx, prog_name in enumerate(target_names, start=1):
        ...
        prog_vals = {
            ...
            'description': f"Autogenerated direct programme for division {div.name}",
            'sequence': 50 + idx,
            'active': True,
